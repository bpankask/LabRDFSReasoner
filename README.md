...
* Create an accurate inference graph which is a full RDFS entailment of the original graph based on the RDFS entailment lemma from the W3C website.  The only exception to this is the order in which the rules are applied to the original graph.
